<%-- 
    Document   : ingresoVideojuego
    Created on : 23-oct-2021, 8:24:44
    Author     : iserg
--%>
    ...
    <body class="grey lighten-5">
        ...
        <nav>
            <div class="nav-wrapper  grey darken-3">
                <a href="#" class="brand-logo center">Ingreso de Videojuego</a>
                ...
                <form class="col s12">
                    <div class="row">
                        <div class="input-field col s6">
                            ...
                            <input id="icon_prefix" type="text" class="validate"name="nombre2" required="Requiere">
                    ...
                    <form action="ingresoVideojuego.jsp">
                        <p>
                            <label>
...
<%
    if (request.getParameter("action") != null) {
        ...
        Statement st = null;
        String nombreV = request.getParameter("nombre2");
        ...
        if (opcion.equals("A")) {
            ...
            try {
                ...
                st.executeUpdate("insert into videojuego (nombreCliente,estado,plataforma) values ('" + nombreV + "','Disponible','PS4')");
            } catch (Exception Ex) {
                out.print(Ex);
            }
            ...
            try {
                st = conn.createStatement();
                st.executeUpdate("insert into videojuego (nombreCliente,estado,plataforma) values ('" + nombreV + "','Disponible','NINTENDO')");
            } catch (Exception Ex) {
                out.print(Ex);
            }
            ...
            try {
                st = conn.createStatement();
                st.executeUpdate("insert into videojuego (nombreCliente,estado,plataforma) values ('" + nombreV + "','Disponible','XBOX')");
            } catch (Exception Ex) {
                out.print(Ex);
            }
        }
